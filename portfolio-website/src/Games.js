...
function Games(){
    return(
      <div className="Games">
        <VidHolder cl="Games" title="Entropy: Desert Colony System" link="https://www.youtube.com/embed/KOtKccehJ-I" text="Entropy: DCS was one of my first Unity games. It centers around a prison colonist sent to set up a colony on a dangerous planet. It was my first experimentation into a slower paced, relaxed game."/>
